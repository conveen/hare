...
| build-release    | `./run.sh build-release`     | Build release containers for Hare component.                                                                                                                                                                 |
...
| kill-postgres    | `./run.sh kill-postgres`     | Kill Postgres container.                                                                                                                                                                                     |
...
| run-cp           | `./run.sh run-cp`            | Run the Hare control plane server on localhost.                                                                                                                                                              |
